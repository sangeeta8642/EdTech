    ...
    try {
      ...
      const response = await fetch('https://api.stripe.com/v1/checkout/sessions', {
        ...
        body: new URLSearchParams({
          'payment_method_types[]': 'card', // Array notation for payment_method_types
          'line_items[0][price_data][currency]': 'usd',
          'line_items[0][price_data][product_data][name]': 'Test Product',
          // 'line_items[0][price_data][product_data][images][0]': {shoe},
          'line_items[0][price_data][unit_amount]': (amount * 100), // Amount in cents
